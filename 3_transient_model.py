...
if __name__ == "__main__":
    ...
    autoencoder.save_model(
        "C:\\Users\\cools\\Desktop\\datasets\\dataset_b\\trans_model"
    )
    ...
    original_y = processed_trans[int(len(y) * 0.9) :]
    predicted_y = autoencoder.predict(x[int(len(x) * 0.9) :])

    audio_pipeline.export_audio_segments_to_wav(
        predicted_y,
        "C:\\Users\\cools\\Desktop\\datasets\\dataset_b\\trans_model\\predicted",
    )
    audio_pipeline.export_audio_segments_to_wav(
        original_x,
        "C:\\Users\\cools\\Desktop\\datasets\\dataset_b\\trans_model\\original_x",
    )
    audio_pipeline.export_audio_segments_to_wav(
        original_y,
        "C:\\Users\\cools\\Desktop\\datasets\\dataset_b\\trans_model\\original_y",
    )
